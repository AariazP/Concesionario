...
public class AdminController {
    ...
    @FXML
    private TableColumn colNombre, colApellido, colCedula, colEmail, colContraseña, colEstado;
    ...
    public void initialize() {
        ...
        estado.getItems().addAll("Activo", "Bloqueado");
    ...
    public void registrar(ActionEvent event){
        ...
        boolean registro = Concesionario.getInstance().registrarEmpleado(nombre, apellido, cedula, email, contrasenia);

        if (!nombre.isEmpty() && !apellido.isEmpty() && !cedula.isEmpty() && !email.isEmpty() && !txtContraseña.getText().isEmpty() && !estado.getItems().isEmpty()) {     //Condición que valida si los campos de textos están vacios.
            if(registro){
                //empleados.add(empleado);
                    JOptionPane.showMessageDialog(null, "Usuario registrado con éxito.");
                    tblEmpleados.setItems(empleados);
                    tblEmpleados.refresh();
                   // tblEmpleados.getItems().addAll(admin.getEmpleados());
    ...
    public void actualizar(ActionEvent event){
        ...
        boolean registrado = Concesionario.getInstance().actualizarDatosEmpleado(nombre, apellido, cedula, email, contraseña);
